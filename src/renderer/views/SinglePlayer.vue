        ...
        <div id="cards-deck" class="cards-deck">
            ...
            <div class="card-column">
                ...
                <Card 
                    ...
                    :elementaltype="card.ElementalType"
                    :type="card.type"
                    :available="(card.cost <= playerMana[0].value) ? true : false"
                    :src="require('./../assets/decks/default/img/'+card.img)"
                    :id="card.id"
                    :ref="card.id"
                    :life="card.life"
            ...
            <div class="card-column">
                ...
                <Card 
                    ...
                    :elementaltype="card.ElementalType"
                    :type="card.type"
                    :available="(card.cost <= playerMana[1].value) ? true : false"
                    :src="require('./../assets/decks/default/img/'+card.img)"
                    :id="card.id"
                    :ref="card.id"
                    :life="card.life"
            ...
            <div class="card-column">
                ...
                <Card 
                    ...
                    :elementaltype="card.ElementalType"
                    :type="card.type"
                    :available="(card.cost <= playerMana[2].value) ? true : false"
                    :src="require('./../assets/decks/default/img/'+card.img)"
                    :id="card.id"
                    :ref="card.id"
                    :life="card.life"
            ...
            <div class="card-column">
                ...
                <Card 
                    ...
                    :elementaltype="card.ElementalType"
                    :type="card.type"
                    :available="(card.cost <= playerMana[3].value) ? true : false"
                    :src="require('./../assets/decks/default/img/'+card.img)"
                    :id="card.id"
                    :ref="card.id"
                    :life="card.life"
            ...
            <div class="card-column">
                ...
                <Card 
                    ...
                    :elementaltype="card.ElementalType"
                    :type="card.type"
                    :available="(card.cost <= playerMana[4].value) ? true : false"
                    :src="require('./../assets/decks/default/img/'+card.img)"
                    :id="card.id"
                    :ref="card.id"
                    :life="card.life"
